...
- El dashboard lee `Saldo al día` desde `H20`, `Total recibido` desde `H17`, `Ahorro` desde `D32`, y `Gastado` desde el valor debajo de `TOTAL DE GASTOS`.
